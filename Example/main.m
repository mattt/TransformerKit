...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        [@{
         ...
         @"CAMelCaseToWhitespaceString" : TKCamelCaseToWhitespaceStringTransformerName,
         @"CAMelCaseToSnakeCaseString" : TKCamelCaseToSnakeCaseStringTransformerName,
         @"snake_case_to_CAMel_case_string": TKSnakeCaseToCamelCaseStringTransformerName,
         @"snake_case_to_LLAma_case_string": TKSnakeCaseToLlamaCaseStringTransformerName,
